...
//        yPrev = y;
    ...
    public void preClimb() {
        ...
        motorOutputLeft = motorControlLeft.pidPosition(leftMeters, currentMetersLeft + 0.2);
        motorOutputRight = motorControlRight.pidPosition(rightMeters, currentMetersRight + 0.2);
